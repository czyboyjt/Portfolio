...
export const PROJECTS: Project[] = [
  ...
  },
 {
    ...
    externalUrl: 'https://www.figma.com/deck/U179JDf8gR5Z6UNRZXrdjM/Seerlight-Presentation?node-id=2047-270&p=f&t=Igtnph3uZPwfzZDB-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1',
    researchImage1: [
...
export const SIDE_PROJECTS: Project[] = [
  {
    ...
    externalUrl: 'https://www.figma.com/deck/eCaQbmorugEJYU3dXvrXBp/GM-Final-Presentation?node-id=1-42&p=f&t=CzkXTdCYahGP9VSJ-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1',
  ...
  },
  {
    ...
    externalUrl: 'https://www.figma.com/deck/etVviKYzzwk14t6bWT1ReJ/Twyne-Presentation?node-id=1-310&p=f&t=Ss6o0qOkKetVapZ5-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1',
